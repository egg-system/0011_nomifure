...
<?php query_posts('post_type=event&suppress_filters=false＆order=ASC&orderby=meta_value&meta_key=_eventorganiser_schedule_start_start&posts_per_page=10&paged='.$paged); ?>
